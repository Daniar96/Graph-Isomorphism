...
class Vertex(object):
    ...
    # TODO change
    def neighbour_colors(self) -> List[int]:
        return [neighbour.color for neighbour in self.neighbours]
...
class Graph(object):
    ...
    def is_isomorphism(self, other) -> bool:
        ...
        other_vertices = other.vertices.copy()
    ...
    def get_vertex(self, color, other_neighbours, vertices):
        for vertex in vertices:
            if vertex.color == color:
                colors = [neighbour.get_color() for neighbour in vertex.neighbours]
                other_colors = [neighbour.get_color() for neighbour in other_neighbours]
                if sum(colors) == sum(other_colors):
